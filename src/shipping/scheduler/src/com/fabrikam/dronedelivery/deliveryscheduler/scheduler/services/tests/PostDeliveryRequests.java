...
import com.fabrikam.dronedelivery.deliveryscheduler.scheduler.services.tests.helpers.ModelsUtils;
...
public class PostDeliveryRequests {
	...
	private static String postUri = "http:ingestion/api/deliveryrequests";
